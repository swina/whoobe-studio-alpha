<template>
    <div class="fixed z-top top-0 left-0 h-screen w-10 theme-dark flex flex-col items-start justify-start pt-8 border-r border-gray-700">
...
export default {
    ...
    methods:{
       ...
       addPluginTab ( item ){
            ...
            this.desktop.tabs.push ( {
                component: 'plugins/' + item.component.config.menu ,//() => import ( '@/components/' + compName ) ,
